...
cd
git clone https://github.com/puribapu9141/OUB-Remix.git
cd OUB-Remix
git remote set-url origin https://${GH_USERNAME}:${GH_PERSONAL_TOKEN}@github.com/puribapu9141/OUB-Remix.git
git fetch
